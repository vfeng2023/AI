...
def highest_heap(board,board_columns):
    ...
    return avg_height,max_height,min_height,height_diff,holes,roughness
...
def heurestic(board,strategy,rowsCleared,columns):
    ...
    value = 0
    ac,ae,bc,be,cc,ce,dc,de,ec,ee,fc,fe,gc,ge = strategy
    avg_val,max_val,wells,diff,numHoles,roughness = highest_heap(board,columns)
