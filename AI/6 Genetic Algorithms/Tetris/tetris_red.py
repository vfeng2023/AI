...
def highest_heap(board):
    ...
    returns average height, max height, min_height, and range
    """
    ...
    return avg_height,max_height,min_height,height_diff
...
def heurestic(board,strategy,rowsCleared):
    ...
    avg_val,max_val,wells,diff = highest_heap(board)
    # print(" avg_val,max_val,wells,diff",avg_val,max_val,wells,diff)
    numHoles = count_holes(board)
