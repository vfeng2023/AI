import sys; args = ["twentyk.txt","13x13","29"]# sys.argv[1:]
...
# def update_poss_next(board,horzWords):
#     while len(indices) > 0:
#         currIndex = indices.pop()
#         horz = indexTohorzStart[currIndex]
#         vert = indexTovertStart[currIndex]
#         for index in horztoIndices[horz]:
#             vertStart = indexTovertStart[index]
#             horzStart = indexTohorzStart[index]
#             relVertIndex = (index-vertStart)//numCols
#             possHorzChars = set()
#             for word in horzWords:
#                 pass
